...
public class Krrish extends Character implements Subject
{
    ...
    private KrrishState hasShotState;
    private KrrishState outOfShotState;
    private KrrishState currState = outOfShotState;
    ...
    /**
     * Krrish builder class. Krrish images are loaded, variable life, health, and points are initialized. Attacks sounds are loaded.
     */
    public Krrish()
    {
        arrImages = new GreenfootImage [3];
        arrImages[0] = new GreenfootImage("Krrish.png");
        arrImages[1] = new GreenfootImage("Krrish.png");
        arrImages[2] = new GreenfootImage("Krrish.png");
        //lives = 3;vmi
		lives = 30;
        health = 50;
    ...
    /**
     * Act - do whatever the Krrish wants to do. This method is called whenever
...
//         }
    ...
    /**
     * When the player presses the spacebar, "Krrish" will launch a shot. 
...
//                 currState.attackEnemy();
    ...
    /**
     * Check if Krrish touch an enemy and destroys it.
     */
    public void isTouchingEnemy()
    {
        Enemy e = (Enemy)getOneIntersectingObject(Enemy.class);
        Kaal g = (Kaal)getOneIntersectingObject(Kaal.class);
        if(e!=null)
        {
    ...
    public void setCurrState(KrrishState state) {
        this.currState = state;
    }
    
    public KrrishState getOutOfShotState(){
        return this.outOfShotState;
    }
    
    public KrrishState getHasShotState(){
